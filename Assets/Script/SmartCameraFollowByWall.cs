...
/// <summary>
/// 스마트 카메라 팔로우 - PlayerMouseMovement 시스템에 맞게 최적화
/// </summary>
public class SmartCameraFollowByWall : MonoBehaviour
{
    ...
    public SwapController swap; // SwapController 참조
    ...
    [Header("Camera State")]
    public bool swapsup = true; // true = P1 포커스, false = P2 포커스
    
    [Header("UI Elements")]
    public GameObject selectmark1; // P1 선택 마커
    public GameObject selectmark2; // P2 선택 마커
    public GameObject Knight_UI;   // P1 UI
    public GameObject Princess_UI; // P2 UI
    
    [Header("Health System")]
    public Player1HP dead;  // P1 체력
    public Player2HP deade; // P2 체력
    ...
    void Update()
    {
        ...
        // SwapController와 동기화 (직접 Tab 입력 처리 제거)
        if (swap != null)
        {
            // SwapController의 상태와 동기화
